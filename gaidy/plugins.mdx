...
Подробное руководство по веб-поиску, включая параметры, формат ответа, совместимость моделей и Responses API — на странице [Поиск в интернете](/gaidy/web-search).
...
<CardGroup cols={2}>
  <Card title="Поиск в интернете" icon="globe" href="/gaidy/web-search">
    Подробный гайд по веб-поиску для любой модели
  </Card>
