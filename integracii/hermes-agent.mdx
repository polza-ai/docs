...
<Steps>
  ...
  <Step title="Настроить провайдер">
    <Tabs>
      <Tab title="Через мастер настройки">
        ```bash
        hermes setup
        ```

        <Frame>
          <img src="https://storage.yandexcloud.net/polza-docs/polza-docs/images/2423bf9f438e0ee326e750c576fe389faa295a9ba318d9f59453f958c37134f1.png" alt="Мастер настройки hermes setup" />
        </Frame>
      ...
      <Tab title="Через файлы конфигурации">
        ...
        Добавьте строку с API-ключом Polza.ai:
        ...
        Найдите раздел `model:` и приведите его к виду:
  ...
  <Step title="Запустить агента">
    ...
    <Frame>
      <img src="https://storage.yandexcloud.net/polza-docs/polza-docs/images/5277671798866a286b1c12a4228dce81d78ba702a3802b0bd8f62a27b3418475.png" alt="Hermes Agent после запуска" />
    </Frame>
...
<Frame>
  <img src="https://storage.yandexcloud.net/polza-docs/polza-docs/images/e341662ec319916f5eb5461db6e44e75915d05f96eb277cbab71a7eea248c4af.png" alt="Веб-дашборд Hermes Agent" />
</Frame>
